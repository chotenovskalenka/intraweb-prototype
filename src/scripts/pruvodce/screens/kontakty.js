...
function renderKontakty(){
  ...
  guides.forEach(g=>{
    ...
    h+=`<div class="tile"><div style="display:flex;align-items:center;gap:10px;margin-bottom:8px">${avatar(g,38)}<b style="font-family:var(--serif);font-size:16px;color:var(--forest-dk)">${g.n} ${g.sur||''}</b></div>`+
